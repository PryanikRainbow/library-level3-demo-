...
var view = {
    ...
    /* helps display the books (collection) */
    /* books - array, iteration*/
    /* for users? */
    /* Нижче можливо для пагінації (очистити книжку?) */
...
/* for the email validity checker */
var controller = {
...
/* ensures that the code in the internal callback will be executed after the page is loaded */
/* Magnific Popup for jQuery */
/* $(function () { ... }) execution when the page loads */
/* $('.popup-modal').magnificPopup({ ... }) popup window */
/*  $.magnificPopup.close(); */
$(function () {
...
/* character escape XSS (Cross-Site Scripting).*/
